...
git push -u origin fix/auditoria-final-producao || (echo ERRO ao enviar para o GitHub.& pause & exit /b 1)
start "" "https://github.com/brasilportalvip-png/Oraculos.ts/compare/main...fix/auditoria-final-producao?expand=1"
echo.
