...
export const NotFoundPage: React.FC<NotFoundPageProps> = ({ onGoHome }) => {
  return (
    <section className="py-16 text-center max-w-xl mx-auto space-y-6 px-4" aria-labelledby="not-found-heading">
      <SEOHead
      ...
      <div className="space-y-2">
        ...
        <h1 id="not-found-heading" className="font-serif text-3xl sm:text-4xl font-light text-white">
